...
for i, pattern in enumerate(patterns):
    ...
    five = [word for word in pattern if len(word) == 5 and len(not_coinciding_wire(nine, word)) == 1 and not len(
        not_coinciding_wire(one, word)) == 0][0]
    three = [word for word in pattern if
             len(word) == 5 and len(not_coinciding_wire(nine, word)) == 1 and len(not_coinciding_wire(one, word)) == 0][
        0]
    ...
    matching_patterns = {sort_string(one): "1", sort_string(two): "2", sort_string(three): "3", sort_string(four): "4",
                         sort_string(five): "5", sort_string(six): "6", sort_string(seven): "7",
                         sort_string(eight): "8", sort_string(nine): "9", sort_string(zero): "0"}
